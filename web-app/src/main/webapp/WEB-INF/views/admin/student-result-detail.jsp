        ...
        java.util.List<common.AcademicYear> academicYears = (java.util.List<common.AcademicYear>)
            ...
            java.util.List<common.Semester> allSemesters = (java.util.List<common.Semester>)
                ...
                java.util.List<common.Subject> allSubjects = (java.util.List<common.Subject>)
                    ...
                    java.util.LinkedHashMap<String, java.util.Map<Integer, java.util.List<common.ExamResult>>> byYear =
                      new
                                  ...
                                  <main class="flex-1 flex flex-col min-w-0">
                                    <%@ include file="header.jsp" %>
                                      ...
                                      <div class="p-4 sm:p-6 space-y-6 w-full max-w-7xl mx-auto">
                                        ...
                                        <!-- Student Info Banner -->
                                        <% if (student !=null) { long totalSubj=results !=null ? results.size() : 0;
                                          long passSubj=results !=null ? results.stream().filter(r ->
                                          ...
                                          <div
                                            ...
                                            <div class="flex items-center gap-6 shrink-0">
                                              <div class="text-center">
                                                ...
                                                <span
                                                  class="text-[10px] text-blue-100 uppercase tracking-wide">စုစုပေါင်း
                                                  ဘာသာ</span>
                                              </div>
                                              <div class="text-center">
                                                <span class="block text-2xl font-black text-emerald-300">
                                                  <%= totalSubj> 0 ? String.format("%.0f",
                                                    (double)passSubj/totalSubj*100) :
                                                    "0" %>%
                                                </span>
                                                <span
                                              ...
                                              <% if (cgpaObj !=null && cgpaObj> 0) { %>
                                                <div class="text-center">
                                                  <span class="block text-2xl font-black text-amber-300">
                                            ...
                                            <div class="p-4 roundedl bg-white border border-slate-200 shadow-sm">
                                              <div
                                                ...
                                                <div class="relative w-full sm:max-w-xs">
                                                  ...
                                                  <% String _sk=(String) request.getAttribute("searchKeyword"); if
                                                    (_sk==null) _sk="" ; %>
                                                    <input type="text" id="detailSearchInput"
                                                      placeholder="ဘာသာရပ် ရှာဖွေရန်..." value="<%= _sk %>" class="w-full pl-10 pr-4 py-2.5 rounded bg-slate-50 border
                                            ...
                                            <% if (byYear.isEmpty()) { %>
                                              ...
                                              <% } else { int yearIdx=0; for (java.util.Map.Entry<String,
                                                ...
                                                java.util.Map<Integer, java.util.List<common.ExamResult>> bySem =
                                                  ...
                                                  <!-- Academic Year Card -->
                                                  <div
                                                    class="year-section rounded-lg overflow-hidden border border-slate-200 shadow-sm bg-white"
                                                    data-year="<%= year %>">
                                                    <!-- Year Header Toggle -->
                                                    <button
                                                      ...
                                                      type="button" onclick="toggleYearCard(this)" aria-expanded="true">
                                                      ...
                                                      <span class="text-sm font-bold text-slate-900 flex-1">ပညာသင်နှစ်
                                                        <%= year %>
                                                      </span>
                                                      <span
                                                    ...
                                                    <div class="year-card-body" id="<%= collapseId %>">
                                                      <div class="bg-white">
                                                        ...
                                                        <% for (java.util.Map.Entry<Integer,
                                                          java.util.List<common.ExamResult>> semEntry :
                                                          bySem.entrySet()) {
                                                          ...
                                                          java.util.List<common.ExamResult> semResults =
                                                            ...
                                                            <!-- Semester Block -->
                                                            <div
                                                              class="sem-block border-b border-slate-200 last:border-b-0"
                                                              data-sem="<%= sem %>">
                                                              <div
                                                                ...
                                                                <div class="flex items-center gap-2">
                                                                  ...
                                                                  <span
                                                                    class="text-xs font-bold text-slate-900">Semester
                                                                    <%= sem %>
                                                                  </span>
                                                                ...
                                                                <button type="button"
                                                                  onclick="printSemesterResult('<%= student != null ? student.getName().replace("'", "\\'") : "" %>', '<%= student != null ? student.getStudentId() : "" %>', '<%= year %>', '<%= sem %>', this, '<%= cgpaObj != null && cgpaObj > 0 ? String.format("%.2f", cgpaObj) : "" %>')"
                                                                  class="inline-flex items-center gap-1.5 px-2.5 py-1
                                                                  rounded bg-slate-100 hover:bg-slate-200 border
                                                                  border-slate-300 text-xs text-slate-700
                                                              ...
                                                              <% for (common.ExamResult r : semResults) { boolean
                                                                ...
                                                                sCredit=r.getSubjectCredit()> 0 ? r.getSubjectCredit() :
                                                                3;
                                                                String gVal = r.getGrade() != null ? r.getGrade() : "";
                                                                String gradeColor = ("A+".equals(gVal) || "A".equals(gVal)) ? "bg-emerald-50 text-emerald-700 border-emerald-300" : ("A-".equals(gVal) || "B+".equals(gVal)) ? "bg-blue-50 text-blue-700 border-blue-300" : ("B".equals(gVal) || "B-".equals(gVal)) ? "bg-cyan-50 text-cyan-700 border-cyan-300" : ("C+".equals(gVal) || "C".equals(gVal)) ? "bg-amber-50 text-amber-700 border-amber-300" : "D".equals(gVal) ? "bg-orange-50 text-orange-700 border-orange-300" : "bg-red-50 text-red-700 border-red-300";
                                                                %>
                                                                <% String sNameVal=r.getSubjectName() !=null ?
                                                                  r.getSubjectName() : "-" ; String
                                                                  sCodeVal=r.getSubjectCode() !=null ?
                                                                  r.getSubjectCode() : "" ; String
                                                                  sTypeVal=r.getExamType() !=null ? r.getExamType()
                                                                  : "REGULAR" ; %>
                                                                  <div
                                                                    ...
                                                                    <div>
                                                                      ...
                                                                      <div
                                                                        ...
                                                                        <%= r.getSubjectCode() !=null ?
                                                                          r.getSubjectCode() : "" %>
                                                                      </div>
                                                                    </div>
                                                                    <div class="text-center marks-cell">
                                                                    ...
                                                                    <div class="text-center grade-cell">
                                                                      <span
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/admin/results"
                                      ...
                                      <input type="hidden" name="studentId"
                                        value="<%= student != null ? student.getId() : 0 %>" />

                                      <div class="modal-body space-y-4">
                                        <div
                                          class="p-3 bg-slate-50 border border-slate-200 rounded-lg flex items-center justify-between">
                                          <span class="text-xs text-slate-500 font-medium">ကျောင်းသား</span>
                                          <strong class="text-xs text-slate-900 font-bold">
                                        ...
                                        <div class="space-y-3">
                                          <div>
                                            ...
                                            <select id="add-semesterId" name="semesterId" required
                                              onchange="filterSubjectsBySemester(this, document.getElementById('add-subjectId'))">
                                              <option value="">-- Semester ရွေးချယ်ပါ --</option>
                                              <% if (allSemesters !=null) { for (common.Semester sm : allSemesters) {
                                                String yrName="" ; if (academicYears !=null) { for (common.AcademicYear
                                                y : academicYears) { if (y.getId()==sm.getAcademicYearId()) {
                                                yrName=y.getYearName(); break; } } } %>
                                                <option value="<%= sm.getId() %>"
                                                  data-sem-number="<%= sm.getSemesterNumber() %>"
                                                  data-sem-id="<%= sm.getId() %>">
                                                  <%= yrName %> — Semester <%= sm.getSemesterNumber() %>
                                                </option>
                                                <% } } %>
                                            </select>
                                          </div>
                                            ...
                                            <select id="add-subjectId" name="subjectId" required>
                                              ...
                                              <% if (allSubjects !=null) { java.util.Set<String> seenSubj = new
                                                java.util.HashSet<>();
                                                  ...
                                                  String key = (sj.getSubjectCode() != null ? sj.getSubjectCode().trim()
                                                  : "") + "|" + (sj.getSemesterNumber() != null ? sj.getSemesterNumber()
                                                  : 0);
                                ...
                                <div class="modal-dialog modal-dialog-centered" style="max-width: 32rem;">
                                  <div class="modal-content">
                                    <div class="modal-accent"
                                      style="background: linear-gradient(90deg, rgb(99 102 241), rgb(168 85 247));">
                                    </div>
                                    <div class="modal-header-custom">
                                      <div class="modal-header-icon"
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/admin/results"
                                      ...
                                      <div class="modal-body space-y-4">
                                        ...
                                        <div class="space-y-3">
                                          <div>
                                            <label class="form-label" for="edit-semesterId">Semester <span
                                                class="text-red-500">*</span></label>
                                          ...
                                          <div>
                                            <label class="form-label" for="edit-subjectId">ဘာသာရပ် <span
                                                class="text-red-500">*</span></label>
                                            <select id="edit-subjectId" name="subjectId" required>
                                              <option value="">-- ဘာသာရပ် ရွေးချယ်ပါ --</option>
                                              <% if (allSubjects !=null) { for (common.Subject sj : allSubjects) { %>
                                                <option value="<%= sj.getId() %>"
                                                  data-sem-id="<%= sj.getSemesterId() %>"
                                                  data-sem-number="<%= sj.getSemesterNumber() != null ? sj.getSemesterNumber() : 0 %>">
                                                  <%= sj.getSubjectCode() %> — <%= sj.getSubjectName() %> (Semester <%=
                                                        sj.getSemesterNumber() !=null ? sj.getSemesterNumber() : "-" %>)
                                                </option>
                                                <% } } %>
                                            </select>
                                          ...
                                          <div class="grid grid-cols-2 gap-3">
                                            <div>
                                              <label class="form-label" for="edit-marks">ရရှိမှတ် <span
                                                  class="text-red-500">*</span></label>
                                              <input type="number" id="edit-marks" name="marks" step="0.5" min="0"
                                                max="100" required />
                                            </div>
                                            <div>
                                              <label class="form-label" for="edit-totalMarks">စုစုပေါင်းမှတ် <span
                                                  class="text-red-500">*</span></label>
                                              <input type="number" id="edit-totalMarks" name="totalMarks" min="1"
                                                required />
                                            </div>
                                          </div>
                                        </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" style="max-width: 24rem;">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-header-custom">
                                      ...
                                      <div class="modal-title-group">
                                        <h5 class="modal-title">ရလဒ် ပယ်ဖျက်ရန်</h5>
                                        <p class="modal-subtitle">Delete Exam Result</p>
                                      </div>
                                      <button type="button" class="modal-close-btn" data-bs-dismiss="modal">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                          stroke="currentColor" stroke-width="2.5">
                                    ...
                                    <form method="post" action="${pageContext.request.contextPath}/admin/results">
                                      ...
                                      <div class="modal-body text-center space-y-3">
                                        <div
                                          class="w-12 h-12 rounded-full bg-red-50 border border-red-100 flex items-center justify-center mx-auto text-red-600">
                                        ...
                                        <h6 class="text-sm font-bold text-slate-900">ဤစာမေးပွဲ ရလဒ်ကို ဖျက်ရန်
                                          သေချာပါသလား?</h6>
                                        <p class="text-xs text-slate-500 font-medium" id="delete-result-name">-</p>
                                        <p class="text-[11px] text-red-500 bg-red-50 p-2 rounded border border-red-100">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn-danger-custom">ဖျက်မည်</button>
                                      </div>
                                    </form>
                                  </div>
                                </div>
                                ...
                                <script>
                                        ...
                                        document.querySelectorAll('.year-section').forEach(function (sec) {
                                          ...
                                          sec.querySelectorAll('.sem-block').forEach(function (blk) {
                                            ...
                                            for (var i = 0; i < rows.length; i++) {
                                              ...
                                              var nameTxt = name.toLowerCase();
                                              var codeTxt = code.toLowerCase();
                                  ...
                                  function printSemesterResult(studentName, rollNo, year, sem, btn, overallCGPA) {
                                    ...
                                    for (var i = 0; i < rows.length; i++) {
                                      ...
                                      var nameEl = r.querySelector('.subj-name');
                                      var nameSpan = nameEl ? nameEl.querySelector('span') : null;
                                      var name = nameSpan ? nameSpan.textContent.trim() : (nameEl ? (nameEl.firstElementChild ? nameEl.firstElementChild.textContent.trim() : nameEl.textContent.trim()) : '-');
                                      ...
                                      var obtained = (marksAttr !== null && marksAttr !== undefined && marksAttr !== '') ? parseFloat(marksAttr) : 0;
                                      var total = (totalMarksAttr !== null && totalMarksAttr !== undefined && totalMarksAttr !== '') ? parseFloat(totalMarksAttr) : 100;
