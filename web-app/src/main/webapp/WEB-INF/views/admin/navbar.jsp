<%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %>
  <%-- navbar.jsp: sessionUser, userEmail, userInitial, pageTitle are declared in sidebar.jsp which is always included
    first --%>
    <!-- ── Top Header Navbar ──────────────────────── -->
    <header class="top-navbar">
      <div class="d-flex align-items-center gap-3">
        ...
        <h2 class="m-0" style="font-size: 1.15rem; font-weight: 700; color: #0f172a;">
          <% if ("Student Management".equalsIgnoreCase(pageTitle) || "Students" .equalsIgnoreCase(pageTitle)) { %>
            ကျောင်းသား/သူများ စီမံခန့်ခွဲမှု
      ...
      <div class="navbar-actions">
        ...
        <div class="d-flex align-items-center gap-2 px-2 py-1 rounded-pill"
          ...
          <div
            style="width: 24px; height: 24px; border-radius: 50%; background-color: #e2e8f0; display: flex; align-items: center; justify-content: center; color: #475569;">
